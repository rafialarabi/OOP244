...
namespace sdds {
	...
	Motorcycle::Motorcycle() : Vehicle(), Sidecar(false){}


	Motorcycle::Motorcycle(const char* licensePlate, const char* makeModel) : Vehicle(licensePlate, makeModel), Sidecar(false) {}
